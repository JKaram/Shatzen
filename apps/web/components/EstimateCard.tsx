  ...
  return (
    <button
      ...
      className={classNames(
        "bg-slate-500 font-bold text-lg h-16 w-10 rounded-lg border-2 active:translate-x-0 active:translate-y-0 active:shadow-none border-black hover:shadow-base transition hover:-translate-x-1 hover:-translate-y-1 ",
